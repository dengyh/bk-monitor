export default {
  ...
  "调试日志": "Debug log",
  "匹配结果": "Match result",
  "全局脱敏设置": "Global desensitization settings",
  "原规则": "Original rule",
  "现规则": "Current rule",
  "匹配字段": "Matching field",
  "匹配正则": "Matching regex",
  ...
  "日志脱敏会结合您的采样日志自动匹配并选用规则，无采样日志无法展示预览结果，请确认您的采样日志规范。若有多类日志，可粘贴至下方采样框内": "Log desensitization will automatically match and select rules based on your sample logs. Without sample logs, the preview results cannot be displayed. Please confirm the specifications of your sample logs. If there are multiple types of logs, you can paste them into the sample box below",
